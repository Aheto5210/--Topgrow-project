...
if (currentUser != null && product.interestedBuyers.contains(currentUser!.uid)) {
...
fontSize: 12,
fontWeight: FontWeight.bold,
color: Color(0xff3B8751), // Match app theme
),
),
TextSpan(
text: formattedDate,
...
return productSnapshot.docs.map((doc) => Product.fromFirestore(doc)).toList();
}
}
