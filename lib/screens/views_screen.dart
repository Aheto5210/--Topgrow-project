...
class _ViewsScreenState extends State<ViewsScreen> {
  ...
  void initState() {
    super.initState();
    // Initialize timeago with English messages
                  ...
                  builder: (context, buyerSnapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final product = interest['product'] as Product;
                        final buyer = interest['buyer'] as Map<String, dynamic>;
                          ...
                          child: ListTile(
                            ...
                            title: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  // Changed from DateFormat to timeago
                                  'Posted: ${timeago.format(product.postedDate)}',
                                  style: const TextStyle(
                                    fontSize: 12,
                                    color: Colors.grey,
                                  ),
                            ...
                            trailing: GestureDetector(
                              onTap: () =>
                                  _callFarmer(context, buyer['phoneNumber']),
                              child: Container(
