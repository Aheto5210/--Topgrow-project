...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    TextSpan(
    text: product.postedDate is Timestamp
    ? DateFormat.yMMMMd().format((product.postedDate as Timestamp).toDate())
        : 'Unknown',
    style: TextStyle(
    ...
    builder: (context, snapshot) {
      ...
      return GridView.builder(
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          childAspectRatio: screenWidth < 320 ? 0.65 : (screenWidth > 600
              ? 0.8
              : 0.7),
        ),
        ...
        itemBuilder: (context, index) {
          ...
          final pageController = _pageControllers[index] ??= PageController();
                            ...
                            ConstrainedBox(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    AutoSizeText(
                                      'GH₵ ${otherProduct.price.toStringAsFixed(
                                          0)}',
                                      style: TextStyle(
                                        fontSize: 14 * scaleFactor,
                                        color: const Color(0xff3B8751),
                        ...
                        Row(
                          children: [
                            ConstrainedBox(
                              ...
                              child: GestureDetector(
                                onTap: () =>
                                    _callFarmer(otherProduct.phoneNumber),
                                child: Container(
                                  decoration: BoxDecoration(
                                    color: const Color(0xff3B8751),
                                    borderRadius: BorderRadius.circular(
